...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes2 > largest_turnout_county_count) and (vote_percentage2 > largest_turnout_county_percentage):
            largest_turnout_county_count = votes2
            largest_turnout_county = county_name
            largest_turnout_county_percentage = vote_percentage2

    # 7: Print the county with the largest turnout to the terminal.
    winning_county_summary = (
        f"-------------------------\n"
        f"Largest county tournout:\n"
        f"-------------------------\n"
        f"Winner: {largest_turnout_county}\n"
