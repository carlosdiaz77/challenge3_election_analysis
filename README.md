...
-The purpose of this project it to apply all that we learned in the module 3, in the Data analysis and visualization  Boot camp of the University of Texas at Austin.
...
-	
-	### We can see the data is very powerful and alreat have very good insights but I’d like to add two more pieces of information that could be used in this and other elections

-	1.  The data can be multi-grouped where in the first level is the county and in the second is the candidate. We would be able to see who won in each county.

-	- <img src = "Resources/proposal1.png" width= "500" >
-	
-	2.  The data can also be shown grouped mainly by candidate and then by county. In this way, we could see where each candidate had better results
-	
